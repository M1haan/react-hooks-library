                ...
                <div style={{
                    ...
                    >
                        ...
                        <p style={{ margin: '0 0 24px 0', color: '#666' }}>
                            Кликните вне этого окна, чтобы закрыть его.
                            Хук useClickAway отслеживает клики вне элемента.
                        </p>
                ...
                {isVisible && (
                    ...
                    >
                        ...
                        <p style={{ margin: '0', fontSize: '12px', opacity: 0.9 }}>
                            Этот тултип закроется, если кликнуть вне его области.
                            Клик по кнопке не закрывает его.
                        </p>
                    </div>
                )}
            </div>
...
const meta = {
    ...
    parameters: {
        docs: {
            description: {
                component: 'Хук для отслеживания кликов вне указанного элемента. Полезно для модальных окон, выпадающих меню и тултипов.',
            },
        },
    },
